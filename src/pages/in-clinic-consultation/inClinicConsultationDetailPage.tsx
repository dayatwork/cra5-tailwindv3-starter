...
const tabs = [
  ...
  { name: 'Referral Data', href: 'referral-data', current: false },
  { name: 'Initial Info', href: 'initial-info', current: true },
  { name: 'Medical Note', href: 'medical-note', current: false },
  { name: 'Laboratorium', href: 'laboratorium', current: false },
  { name: 'Prescription', href: 'prescription', current: false },
  { name: 'Procedure', href: 'procedure', current: false },
  { name: 'Embryo', href: 'embryo', current: false },
  { name: 'Refer Patient', href: 'refer-patient', current: false },
  { name: 'Informed Consent', href: 'informed-consent', current: false },
]
...
export default function InClinicConsultationDetailPage() {
