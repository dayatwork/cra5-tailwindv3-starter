      ...
      },
      {
        ...
        Cell: ({ row }: any) => (
          <Link
            ...
            className="text-xs font-semibold px-4 py-1.5 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-full"
          >
            Edit
          </Link>
        ),
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <Link
          to="add"
          className="bg-primary-500 pl-3 pr-4 py-2 rounded-full text-white hover:bg-primary-600 shadow-sm text-sm font-semibold flex items-center space-x-2"
        >
