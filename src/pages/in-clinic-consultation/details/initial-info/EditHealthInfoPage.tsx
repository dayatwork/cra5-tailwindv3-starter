    ...
    <div>
      ...
      <div className="p-6 rounded-lg shadow-lg bg-white max-w-xl">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold">Edit Health Information</h2>
            <p className="text-lg font-semibold text-gray-600">Mrs. Jane Doe</p>
          </div>
          <MdFemale className="h-12 w-12 text-blue-400" />
        </div>
