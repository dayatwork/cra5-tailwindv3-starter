    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6 flex items-center justify-between">
          ...
          <Link
            to="health-info/edit"
            className="text-primary-600 bg-primary-50 rounded-full pl-4 pr-3 py-1.5 text-sm font-semibold hover:bg-primary-100 shadow-sm flex items-center space-x-1"
          >
            <span>Edit</span>
